...
SQL-eksempler for å hente og legge inn data
Frontend:
HTML/CSS/JS-sider med eksempeldata
Viser meny, åpningstider, kontakt og bestillingsside
Backend:
NodeJS/Express henter og lagrer data
